...
/* Funkcija ucitava elemente kvadratne matrice sa 
   standardnog ulaza */
...
/* Funkcija ispisuje elemente kvadratne matrice na 
   standardni izlaz */
...
int ortonormirana(int m[][MAX], int n) 
{
  ...
  /* Ako su oba uslova ispunjena, vracamo jedinicu kao 
     rezultat */
  return 1;
}
...
int main() 
{
  ...
  /* Ucitavamo vrednost dimenzije i proveravamo njenu 
     korektnost */
  scanf("%d", &n);
