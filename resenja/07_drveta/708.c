...
void kopiraj_stablo(Cvor * koren, Cvor ** duplikat)
{
  ...
  *duplikat = napravi_cvor(koren->broj);
  ...
  /* Rekurzivno se duplira levo podstablo i njegova adresa se
     cuva u pokazivacu na levo podstablo korena duplikata. */
  kopiraj_stablo(koren->levo, &(*duplikat)->levo);

  /* Rekurzivno se duplira desno podstablo i njegova adresa se
...
void kreiraj_razliku(Cvor ** adresa_korena1, Cvor * koren2)
{
  ...
  /* Kreira se razlika levog i desnog podstabla sa drugim
     stablom, tj. iz levog i desnog podstabla prvog stabla se
...
int main()
{
  ...
  /* Kreira se presek skupova: prvo se napravi kopija prvog
     skupa kako bi se isti mogao iskoristiti i za preostale
     operacije */
  kopiraj_stablo(skup1, &pomocni_skup);
  ...
  /* Kreira se razlika skupova: prvo se napravi kopija prvog
     skupa kako bi se isti mogao iskoristiti i za preostale
     operacije */
  kopiraj_stablo(skup1, &pomocni_skup);
