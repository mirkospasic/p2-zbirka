...
/* Struktura kojom se predstavlja cvor binarnog pretrazivackog stabla 
 */
typedef struct cvor {
  int broj;
...
/* Funkcija koj pronalazi cvor koji sadrzi najmanju vrednost u stablu 
 */
Cvor *pronadji_najmanji(Cvor * koren);

/* Funkcija koja pronalazi cvor koji sadrzi najvecu vrednost u stablu 
 */
...
/* Funkcija koja ispisuje stablo u infiksnoj notaciji (Levo podstablo 
