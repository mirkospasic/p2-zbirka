...
/* Funkcija koja pronalazi cvor koji sadrzi najmanju vrednost
u stablu */
Cvor * pronadji_najmanji(Cvor * koren);

/* Funkcija koja pronalazi cvor koji sadrzi najveci vrednost u stablu
*/
...
/* Funkcija koja ispisuje sadrzaj stabla u infiksnoj notaciji (levo
