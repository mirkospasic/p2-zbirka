...
int count_bits1(int x)
{
  ...
  /* Formiranje se maska cija binarna reprezentacija izgleda
      100000...0000000, koja sluzi za ocitavanje
...
/* Funkcija vraca broj jedinica u binarnoj reprezentaciji broja
   x formiranjem odgovarajuce maske i pomeranjem promenljive x
    */
int count_bits2(int x)
{
  ...
  /* Kako je argument funkcije oznacen ceo broj x naredba x>>=1 vrsila 
     ...
     Zbog toga se koristi pomeranje broja x ulevo i maska koja 
