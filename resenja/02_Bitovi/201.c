...
void print_bits(unsigned x)
{
  ...
  /* Pocetna vrednost maske se postavlja na broj ciji binarni 
   ...
   svim ostalim mestima sadrzi nulu. U svakoj iteraciji maska se menja 
   tako sto se jedini bit jedinica pomera udesno, kako bi se ocitao naredni bit
   broja x koji je argument funkcije. Odgovarajuci
   karakter, ('0' ili '1'), ispisuje se na standardnom izlazu. Neophodno je da 
   promenljiva maska bude deklarisana kao neoznacen ceo
