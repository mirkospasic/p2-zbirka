...
\begin{Answer}[ref=3-11]
  ...
  \includecodeLib{resenja/05_Sortiranje/3-11.c}{main.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-12]
  \includecode{resenja/05_Sortiranje/3-12.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-13]
  \includecode{resenja/05_Sortiranje/3-13.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-14]
  \includecode{resenja/05_Sortiranje/3-14.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-15]
  \includecode{resenja/05_Sortiranje/3-15.c}
\end{Answer}
...
\begin{Answer}[ref=3-16]
  \includecode{resenja/05_Sortiranje/3-16.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-17]
  \includecode{resenja/05_Sortiranje/3-17.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-18]
  \includecode{resenja/05_Sortiranje/3-18.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-19]
  \includecode{resenja/05_Sortiranje/3-19.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%  \includecode{resenja/05_Sortiranje/3-20.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-21]
  \includecode{resenja/05_Sortiranje/3-21.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-22]
  \includecode{resenja/05_Sortiranje/3-22.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-23]
  \includecode{resenja/05_Sortiranje/3-23.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\includecode{resenja/05_Sortiranje/3-24.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%  \includecode{resenja/05_Sortiranje/3-25.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%  \includecode{resenja/05_Sortiranje/3-26.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-27]
  \includecode{resenja/05_Sortiranje/3-27.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%  \includecode{resenja/05_Sortiranje/3-28.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-30]
  \includecode{resenja/05_Sortiranje/3-30.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-31]
  \includecode{resenja/05_Sortiranje/3-31.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-32]
  \includecode{resenja/05_Sortiranje/3-32.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-33]
  \includecode{resenja/05_Sortiranje/3-33.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-34]
  \includecode{resenja/05_Sortiranje/3-34.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-35]
  \includecode{resenja/05_Sortiranje/3-35.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-36]
  \includecode{resenja/05_Sortiranje/3-36.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-37]
  \includecode{resenja/05_Sortiranje/3-37.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%  \includecode{resenja/05_Sortiranje/3-38.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
