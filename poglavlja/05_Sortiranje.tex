...
\begin{Exercise}[label=505]
  ...
  \komentar{Milena: Ovde nedostaju neke pretpostavke o dimenzijama}
\begin{miditest}
\begin{test}{Test 1}
...
\begin{Exercise}[label=507]
  ...
  treba da sadrži \kckod{selection}, \kckod{merge}, \kckod{quick}, \kckod{bubble}, 
  \kckod{insertion} i \kckod{shell sort}. Upotrebiti biblioteku kako 
...
\komentar{Milena: Ovde je mozda logicnije da se rezultati upusuju u neku datoteku, a ne na stdout?}
...
\komentar{Milena: treba naci kako se obelezava tezina u okviru exercise okruzenja}
...
\komentar{Milena: Nije mi jasno u kojim jedinicama se unosi brzina, razdaljina i vreme? Znam da to ne utice na resavanje zadatka, ali mi se cini da bi zadatak bio jasniji kada bi se pomenuli neki metri i sekunde? A mozda i ne bi?}
...
\begin{ckod}
    ...
    2    2__  5    5
\end{ckod}
\komentar{Milena: Objasniti sta znaci prethodna slika, sta su brojevi a sta crtice}

Napisati program koji u najviše \kckod{2n-3} okretanja sortira učitani
niz. Uputstvo: imitirati \kckod{selection sort} i u svakom koraku dovesti
...
\begin{Exercise}[label=517]
  ...
  zatim funkcijama \kckod{bsearch} i \kckod{lfind} utvrditi da li se zadati broj 
  nalazi u nizu i na standardni izlaz ispisati odgovarajuću poruku. 
  \komentar{Milena: Mislim da bi naredno trebalo da ide u zaseban zadatak jer nema mnogo smisla da sve ovde bude zajedno.}
  Upotrebom funckcije \kckod{qsort} sortirati niz u rastućem poretku prema broju delilaca.
...
\begin{Exercise}[label=518]
  ...
  \komentar{Milena: ovde nije jasno da li ce biti dati test primeri biti za prvobitni ili za prosiren zadatak? Treba nekako preformulisati zadatak jer mi je malo nepovezan i nije jasno sta da se radi sa njegovim delovima.}
\begin{miditest}
\begin{test}{Test 1}
TODO
\end{test}
...
\begin{Exercise}[label=521]
  ...
  raspoređenih)
  \komentar{Milena: Ovakav zadatak je vec bio, ali bez bibliotecke funkcije. Trebalo bi se referisati na njega, kao u zadatku 99, ali sa ref}
