...
%\komentar{Milena:ovde u tekstu nedostaje objasnjenje koja su znacenja argumenata komandne linije. Ovako mi test primeri deluju nejasno}
...
%\komentar{Milena: mozda ovde dodati test primer za stampanje poruke kada se ne pronadje vrednost?}  
...
%  \komentar{Milena:dodati jos jedan testprimer}
\begin{miditest}
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Uneti dimenziju niza:}\ulaz{10}#
...
%\komentar{Milena: ovo je malo besmislen zadatak. Mozda nakon binarne pretrage sortirati po duzini, pa onda primeniti linearnu pretragu jer niz vise nije sortiran leksikografski pa ne mozemo da trazimo binarnom po kriterijumu imena...}
