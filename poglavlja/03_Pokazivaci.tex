...
\begin{Exercise}[label=biblioteka]
...
\item Napisati funkciju \kckod{void ucitaj\_matricu(int **A, int n,
  int m)} koja učitava već alociranu matricu dimenzija $n \times m$ sa
  standardnog ulaza.
\item Napisati funkciju \kckod{void ucitaj\_kvadratnu\_matricu(int
  **A, int n)} koja učitava već alociranu kvadratnu matricu dimenzije
  $n$ sa standardnog ulaza.
\item Napisati funkciju \kckod{void ispisi\_matricu(int **A, int n,
  int m)} koja ispisuje matricu dimenzija $n \times m$ na standardnom
  izlazu.
\item Napisati funkciju \kckod{void ispisi\_kvadratnu\_matricu(int
  **A, int n)} koja ispisuje kvadratnu matricu dimenzije $n$ na
  standardnom izlazu.
...
\item Napisati funkciju \kckod{int
  ...
  koja učitava već alociranu kvadratnu matricu dimenzije $n$ iz već
...
\item Napisati funkciju \kckod{int upisi\_matricu\_u\_datoteku(int
  **A, int n, int m, FILE * f)} koja upisuje matricu dimenzija $n
...
\item Napisati funkciju \kckod{int
  ...
  koja upisuje kvadratnu matricu dimenzije $n$ u već otvorenu datoteku
...
\begin{enumerate}
\item[(1)] Program učitava dimenzije nekvadratne matrice sa
...
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesi broj vrsta matrice:}##\ulaz{3}#
#\izlaz{Unesi broj kolona matrice:}##\ulaz{4}#
#\izlaz{Unesi elemente matrice po vrstama:}#
#\ulaz{1 2 3 4}#
#\ulaz{5 6 7 8}#
#\ulaz{9 10 11 12}#
...
\begin{upotreba}{2}
#\naslovInt#
#\izlaz{Unesi broj vrsta matrice:}##\ulaz{5}#
#\izlaz{Unesi broj kolona matrice:}##\ulaz{0}#
#\izlaz{Neodgovarajce dimenzije matrice}#
\end{upotreba}
\end{miditest}
...
#\naslovIzlaz#
#\izlaz{Neispravan pocetak fajla}#
\end{test}
\end{minitest}
\begin{minitest}
\begin{test}{3}
...
\end{enumerate}
\linkresenje{biblioteka}
\end{Exercise}
\begin{Answer}[ref=biblioteka]
\includecodeLib{resenja/03_Pokazivaci/biblioteka/matrica.h}{matrica.h}
\includecodeLib{resenja/03_Pokazivaci/biblioteka/matrica.c}{matrica.c}
\includecodeLib{resenja/03_Pokazivaci/biblioteka/main_a.c}{main\_a.c}
\includecodeLib{resenja/03_Pokazivaci/biblioteka/main_b.c}{main\_b.c}
\end{Answer}
