...
\begin{Exercise}[label=3_06]
  ...
  $0.001$ od nule. \uputstvo{Korisiti metod polovljenja intervala
    (algoritam analogan algoritmu binarne pretrage).}  \napomena{Ovaj
    metod se može primeniti na funkciju \kckod{cos(x)} na intervalu
    $[0,2]$ zato što je ona na ovom intervalu neprekidna, i vrednosti
    funkcije na krajevima intervala su različitog znaka.}
...
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesite broj tacaka:}\ulaz{2}#
#\izlaz{Unesite koordinate tacaka:}#
#\ulaz{2 0 2 1}#
#\ulaz{1 2 2 2}#
#\izlaz{26.57}#
\end{upotreba}
...
\begin{upotreba}{3}
#\naslovInt#
#\izlaz{Unesite broj tacaka:}\ulaz{3}#
#\izlaz{Unesite koordinate tacaka:}#
#\ulaz{1 0 1 1}#
#\ulaz{2 0 2 1}#
#\ulaz{1 2 2 2}#
...
\begin{Exercise}[label=3_18]
  ...
  \kckod{ceo-tok.txt}. Pretpostaviti da ime studenta nije duže od
...
\begin{Exercise}[label=3_20]
  Napisati program koji učitava imena i prezimena građana iz datoteke \kckod{biracki-spisak.txt} i kreira biračke
...
\begin{Exercise}[label=3_23]
  ...
  proizvođačima i cenama učitati iz datoteke
...
\begin{Exercise}[label=3_24]
   ...
   spiska redom u datoteke \kckod{dat1.txt}, \kckod{dat2.txt} i
   \kckod{dat3.txt}. Na prvom su studenti sortirani leksikografski po
...
\begin{upotreba}{1}
#\naslovInt#
#\izlaz{Unesite niz operacija:}\ulaz{U 2 U 0 U 6 U 4 N 1 U 8 N 2 N 5 U 2 N 3 N 5}#
#\izlaz{0 2 8 2 6}
\end{upotreba}
\end{maxitest}
...
#\naslovInt#
#\izlaz{Unesite sledeci datum:}\ulaz{13.12.2016.}#
#\izlaz{postoji}#
#\izlaz{Unesite sledeci datum:}\ulaz{10.5.2015.}#
#\izlaz{ne postoji}#
#\izlaz{Unesite sledeci datum:}\ulaz{5.2.2009.}#
#\izlaz{postoji}#
\end{test2}
\end{miditest}
