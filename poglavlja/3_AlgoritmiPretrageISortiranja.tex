...
\begin{Answer}[ref=3-01]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-01.c}
\end{Answer}
...
\begin{Answer}[ref=3-02]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-02.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-03]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-03.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-04]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-04.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-05]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-05.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-06]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-06.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-07]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-07.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-08]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-08.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-09]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-09.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-11]
  \includecodeLib{resenja/3_AlgoritmiPretrageISortiranja/sort.h}{sort.h}
  \includecodeLib{resenja/3_AlgoritmiPretrageISortiranja/sort.c}{sort.c}
  \includecodeLib{resenja/3_AlgoritmiPretrageISortiranja/3-11.c}{main.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-12]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-12.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-13]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-13.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-14]
  ...
  elemenata. \uputstvo{Prvo sortirati niz, a zatim naći najdužu
    ...
    sortiranje celih brojeva iz zadatka \ref{3-11}.}
...
\begin{Answer}[ref=3-14]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-14.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-15]
  ...
  u niz neće biti uneto više od $256$ brojeva.  \uputstvo{Prvo
    ...
    celih brojeva iz zadatka \ref{3-11}.}
...
\begin{Answer}[ref=3-15]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-15.c}
\end{Answer}
...
\begin{Answer}[ref=3-16]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-16.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-17]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-17.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-18]
...
\begin{Answer}[ref=3-18]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-18.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-19]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-19.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-20]
\iffalse
...
%\begin{Answer}[ref=3-20]
%  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-20.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-21]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-21.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-22]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-22.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-23]
...
\begin{Answer}[ref=3-23]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-23.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-24]
...
\includecode{resenja/3_AlgoritmiPretrageISortiranja/3-24.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%\begin{Answer}[ref=3-25]
%  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-25.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[difficulty=2, label=3-26]
...
%\begin{Answer}[ref=3-26]
%  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-26.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-27]
...
\begin{Answer}[ref=3-27]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-27.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%\begin{Answer}[ref=3-28]
%  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-28.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
%\begin{Answer}[ref=3-29]
%  \includecode{resenja/04_Pretrazivanje/3-29.c}
%\end{Answer}
%-----------------------------------------------------------------



\begin{Exercise}[label=3-30]
...
\begin{Answer}[ref=3-30]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-30.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-31]
...
\begin{Answer}[ref=3-31]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-31.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-32]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-32.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-33]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-33.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-34]
...
\begin{Answer}[ref=3-34]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-34.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-35]
  Uraditi zadatak \ref{3-12}, ali korišćenjem bibliotečke \kckod{qsort}
  funkcije.
...
\begin{Answer}[ref=3-35]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-35.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
...
\begin{Answer}[ref=3-36]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-36.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-37]
...
\begin{Answer}[ref=3-37]
  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-37.c}
\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
\begin{Exercise}[label=3-38]
...
%\begin{Answer}[ref=3-38]
%  \includecode{resenja/3_AlgoritmiPretrageISortiranja/3-38.c}
%\end{Answer}
%-----------------------------------------------------------------
%-----------------------------------------------------------------
