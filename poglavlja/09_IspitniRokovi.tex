...
\includecode{resenja/5_IspitniRokovi/5_01.c}
\end{Answer}


\begin{Exercise}[label=5_02]
Data je biblioteka za rad sa binarnim pretraživačkim stablima čiji čvorovi sadrže cele brojeve. 
Napisati funkciju   \kckod{int sumiraj_n (Cvor * koren, int n)}
...
Napisati program koji sa standardnog ulaza učitava najpre prirodan broj $n$, a potom i brojeve sve do pojave nule koje smešta u stablo i ispisuje rezultat pozivanja funkcije \kckod{sumiraj_n} za broj $n$ i tako kreirano stablo. U slučaju greške na standardni izlaz za grešku ispisati \argf{-1}.
...
\linkresenje{5_02}
\end{Exercise}
\begin{Answer}[ref=5_02]
%\includecode{resenja/5_IspitniRokovi/5_02/stabla.h}
%\includecodeLib{resenja/5_IspitniRokovi/5_02/stabla.h}{stabla.h}
%\includecodeLib{resenja/5_IspitniRokovi/5_02/stabla.c}{stabla.c}
\\
\napomena{Rešenje koristi biblioteku za rad sa binarnim pretraživačkim stablima iz zadatka \ref{701}.}
\includecodeLib{resenja/5_IspitniRokovi/5_02/main.c}{main.c}
%\includecode{resenja/5_IspitniRokovi/5_02/stabla.c}
%\includecode{resenja/5_IspitniRokovi/5_02/main.c}
\end{Answer}

\begin{Exercise}[label=5_03]
...
\includecode{resenja/5_IspitniRokovi/5_03.c}
\end{Answer}

\section{Programiranje 2, praktični deo ispita, jul 2015.}

\begin{Exercise}[label=5_04]
...
\linkresenje{5_04}
\end{Exercise}
\begin{Answer}[ref=5_04]
\includecode{resenja/5_IspitniRokovi/5_04.c}
\end{Answer}


\begin{Exercise}[label=5_05]
...
\begin{Answer}[ref=5_05]
\includecode{resenja/5_IspitniRokovi/5_05.c}
\end{Answer}

\begin{Exercise}[label=5_06]
Data je biblioteka za rad sa binarnim pretraživačkim stablima celih brojeva. Napisati funkciju\\ 
\kckod{int prebroj_n(Cvor *koren, int n)}\\
...
%%\includecode{resenja/5_IspitniRokovi/5_06/stabla.h}  
%\includecodeLib{resenja/5_IspitniRokovi/5_06/stabla.h}{stabla.h}
%\includecodeLib{resenja/5_IspitniRokovi/5_06/stabla.c}{stabla.c}
\\
\napomena{Rešenje koristi biblioteku za rad sa binarnim pretraživačkim stablima iz zadatka \ref{701}.} % trebalo bi \ref{4_14}
\includecodeLib{resenja/5_IspitniRokovi/5_06/main.c}{main.c}
%%\includecode{resenja/5_IspitniRokovi/5_06/stabla.c}
%%\includecode{resenja/5_IspitniRokovi/5_06/main.c}
\end{Answer}
...
\includecode{resenja/5_IspitniRokovi/5_07.c}
\end{Answer}


\begin{Exercise}[label=5_08]
...
%\includecode{resenja/5_IspitniRokovi/908/liste.h}
\includecodeLib{resenja/5_IspitniRokovi/5_08/liste.h}{liste.h}
\includecodeLib{resenja/5_IspitniRokovi/5_08/liste.c}{liste.c}
\includecodeLib{resenja/5_IspitniRokovi/5_08/main.c}{main.c}
%\includecode{resenja/5_IspitniRokovi/908/liste.c}
%\includecode{resenja/5_IspitniRokovi/908/main.c}
\end{Answer}

\begin{Exercise}[label=5_09]
Sa standardnog ulaza se učitava dimenzija \kckod{n} kvadratne celobrojne
    ...
    \napomena{Rešenje koristi biblioteku za rad sa matricama iz zadatka \ref{biblioteka}.}
...
\includecode{resenja/5_IspitniRokovi/5_09.c}
\end{Answer}
