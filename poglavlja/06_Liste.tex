...
#\naslovIzlaz#
#\izlaz{Etikete nisu pravilno uparene}#
#\izlaz{(nadjena je etiketa </html> koja nije otvorena)}# 
\end{test}
\end{miditest}
...
Sve funkcije za rad sa listom implementirati iterativno. Zbog efikasnog izvršavanja operacija dodavanja na kraj liste i ispisivanja liste unazad treba pored pokazivača na glavu liste čuvati i pokazivač na poslednji cvor liste.
\napomena{Funkcije testirati kroz \kckod{main} programe poput onih iz zadatka \ref{601} i koristiti test primere iz istog zadatka. }
\linkresenje{610}
\end{Exercise}
