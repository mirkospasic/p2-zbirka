...
\napomena{Funkcije testirati kroz \kckod{main} programe iz zadatka \ref{601} i koristiti test primere iz istog zadatka. }
\linkresenje{611}
\end{Exercise}
\begin{Answer}[ref=611]
\includecodeLib{resenja/06_Liste/611/lista.h}{lista.h}
\includecodeLib{resenja/06_Liste/611/lista.c}{lista.c}
