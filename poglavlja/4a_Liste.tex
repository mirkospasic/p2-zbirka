...
\item Napisati funkciju \kckod{Cvor *napravi\_cvor(int broj)} koja kao argument dobija ceo broj, kreira nov čvor liste, inicijalizuje mu polja i vraća njegovu adresu.
 ...
 \item Napisati funkciju \kckod{Cvor *pretrazi\_listu(Cvor * glava, int broj)} koja proverava da li se u listi nalazi čvor čija je vrednost jednaka argumentu \argf{broj}. Vraća pokazivač na pronađeni čvor ili \kckod{NULL} ukoliko ga ne pronađe.
 ...
 \item Napisati funkciju \kckod{void obrisi\_cvor\_sortirane\_liste(Cvor ** adresa\_glave, int broj)} koja briše sve čvorove u listi koji imaju vrednost jednaku argumentu \argf{broj}, pri čemu se pretpostavlja da se briše iz neopadajuće uređene liste.
...
\napomena{Koristiti iste \kckod{main} programe i test primere iz zadatka \ref{4_01}.}
\linkresenje{4_02}
\end{Exercise}
...
\napomena{Koristiti biblioteku za rad sa listama celih brojeva iz zadatka \ref{4_01}.}
...
\napomena{Iskoristiti testove 2 - 6 za zadatak \ref{4_06}.}
...
\napomena{Funkcije testirati koristeći test primere iz zadatka \ref{4_01}}
\linkresenje{4_11}
\end{Exercise}
