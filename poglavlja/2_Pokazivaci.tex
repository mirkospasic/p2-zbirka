...
\end{enumerate} 
\skrati{1}
Od korisnika tražiti da izabere koje od ova dva
...
brojeva. Brojevi se unose sve dok se ne unese nula. Na standardni izlaz
ispisati ovaj niz brojeva u obrnutom poretku. Ne praviti
nikakve pretpostavke o dimenziji niza. Zadatak uraditi na dva načina:
\begin{enumerate}
...
\item Napisati funkciju \kckod{void ispisi\_matricu(int **A, int n,
  int m)} koja ispisuje matricu dimenzije $n \times m$ na standardni
  izlaz.
...
#\naslovIzlazZaGresku#
#\izlaz{Greska: Broj vrsta i broj kolona ne }#
#\izlaz{mogu biti negativni brojevi.}#
\end{upotreba}
\end{miditest}
...
#\naslovIzlazZaGresku#
#\izlaz{Greska: Neispravan pocetak}#
#\izlaz{datoteke.}#
\end{test}
\end{minitest}
\begin{minitest}
