...
\item Napisati funkciju \kckod{int dodaj\_u\_stablo(Cvor ** adresa\_korena, int broj)} koja u stablo na koje pokazuje argument \argf{koren} dodaje ceo broj \argf{broj}. Povratna vrednost funkcije je 0 ako je dodavanje uspešno, odnosno 1 ukoliko je došlo do greške.  
...
\includecodeLib{resenja/07_drveta/stabla.h}{stabla.h}
\includecodeLib{resenja/07_drveta/stabla.c}{stabla.c}
\includecodeLib{resenja/07_drveta/701.c}{main.c}
\end{Answer}
