...
\item Napisati funkciju \kckod{void dodaj\_u\_stablo(Cvor ** adresa_korena, int broj)} koja u stablo na koje pokazuje argument \argf{koren} dodaje ceo broj \argf{broj}.
...
\item Napisati funkciju \kckod{void obrisi\_element(Cvor ** adresa_korena, int broj)} koja briše čvor koji sadrži vrednost \argf{broj} iz stabla na koje pokazuje argument \argf{koren}.
...
\item Napisati funkciju \kckod{void oslobodi\_stablo(Cvor ** adresa_korena)} koja oslobađa memoriju zauzetu stablom na koje pokazuje argument \argf{koren}.
\end{enumerate}
