...
\begin{Exercise}[label=202]
 Napisati funkciju koja broji bitove postavljene na \argf{1} u zapisu celog broja $x$, tako što se pomeranje vrši nad
\begin{enumerate}
\item maskom,
\item brojem $x$.
\end{enumerate} 
...
\komentar{Jelena: Da li je u redu da na izlazu bude ovakvo poravnanje?}
\begin{maxitest}
\begin{test}{Test 1}
Ulaz:   235 5 10 127  
Izlaz:  
