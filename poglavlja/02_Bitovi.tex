...
Napisati biblioteku za rad sa polinomima.
  ...
  \item Napisati funkciju \kckod{void ispisi(const Polinom * p)} koja ispisuje polinom \kckod{p} na standardni izlaz.
...
\begin{enumerate}
\item Napisati funkciju \kckod{reset} koja određuje broj koji se dobija kada se $n$ bitova datog broja $x$, počevši od pozicije $p$, postave na \argf{0}. Na primer, za n=5, p=10 za broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1010 1110 0111 
funkcija  \kckod{reset} vraća broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1000 0010 0111.
\item Napisati funkciju \kckod{set} koja određuje broj koji se dobija kada se $n$ bitova datog broja $x$, počevši od pozicije $p$, postave na \argf{1}.  Na primer, za n=5, p=10 za broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1010 1110 0111
funkcija  \kckod{set} vraća broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1111 1110 0111.
\item Napisati funkciju \kckod{get\_bits} koja određuje broj koji se dobija od $n$ bitova datog broja $x$, počevši od pozicije $p$, i vraća ih kao bitove najmanje težine rezultata. Na primer , za n=5, p=10 za broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1010 1110 0111
funkcija  \kckod{get\_bits} vraća broj čija je binarna reprezentacija:
0000 0000 0000 0000 0000 0000 0000 1011.
\item Napisati funkciju \kckod{set\_n\_bits} koja vraća broj koji se dobija upisivanjem poslednjih $n$ bitova broja $y$ u broj $x$, počevši od pozicije $p$. Na primer, za n=5, p=10 ako su binarne reprezentacije brojeva $x$ i $y$ redom:
1010 1011 1100 1101 1110 1010 1110 0111
1110 1010 1110 0111 1010 1011 1100 1101 
funkcija  \kckod{set\_n\_bits} vraća broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1011 0110 0111.
\item Napisati funkciju \kckod{invert} koja vraća broj koji se dobija invertovanjem $n$ bitova broja $x$ počevši od pozicije $p$. Na primer, za n=5, p=10 za broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1010 1110 0111 
funkcija  \kckod{reset} vraća broj čija je binarna reprezentacija:
1010 1011 1100 1101 1110 1101 0010 0111.
\end{enumerate}
