...
#\izlaz{(1.00 - 3.00 i)}#
#\izlaz{realan\_deo: 1}#
#\izlaz{imaginaran\_deo: -3.000000}#
...
Napisati program koji testira prethodno napisane funkcije. Program najpre učitava polinom \argf{p} sa standardnog ulaza i ispisuje ga na standardni izlaz u odgovarajućem obliku. Nakon toga program računa i ispisuje vrednost tog polinoma (zaokruženu na dve decimale) u tački koju unosi korisnik.  Potom se unosi polinom \argf{q}, i ispisuju se zbir i proizvod polinoma \argf{p} i \argf{q}. Na kraju se sa standardnog ulaza unosi broj \argf{n}, i ispisuje \argf{n}-ti izvod polinoma \argf{p}.

%\komentar{Milena: I ovaj program je poprilicno besmislen --- smisliti nesto bolje.}
...
%\komentar{Milena: Bilo bi lepo ovaj zadatk preformulisati da bude kao kod jeleninog zadatka 2.4 gde se od korisnika trazi da na neki nacin izabere koju od te dve funkcije ce koristiti}
...
#\naslovIzlaz#
#\izlaz{Broj jedinica u zapisu je}#
#\izlaz{funkcija count\_bits1: 16}#
...
#\izlaz{funkcija count\_bits2: 17}#
\end{test}
\end{miditest}
...
%\komentar{Milena: Ovo treba da bude upotreba, a ne test. Takodje, prvo odstampati broj i y, pa onda redom pozive funkcija. Ovako ono y zbunjuje u sredini}
...
%\komentar{Milena: Po pravilima bi i ovo trebala da bude upotreba}
...
%\komentar{Milena: nedostaje bar jedan test primer}
