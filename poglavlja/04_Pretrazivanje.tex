...
\begin{Exercise}[label=401]
  ...
  \argf{n} (prvi argument komandne linije, ne veći od $1000000$), i u
  njemu već napisanim funkcijama traži element \argf{x} (drugi
  argument komandne linije). Potrebna vremena za izvršavanje ovih
  funkcija upisati u fajl \kckod{vremena.txt}.
