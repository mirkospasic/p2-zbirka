...
\begin{Exercise}[label=403]
  ...
  rekurzivne.
   \komentar{Milena: Ovde nije jasno koje su to trazene funkcije jer se u prethodnom zadatku ni jedna funkcija ne trazi eksplicitno.}
\end{Exercise}
...
\begin{Exercise}[label=407]
  ...
  kraja ulaza.
  \komentar{Milena: Trebalo bi imati rekurzivnu implementaciju i za prve dve vrste pretrage, a ovaj zadatak bi trebao da ide uz onaj prvi. Takodje, tamo treba naglasiti da su u pitanju iterativne funkcije. }
\begin{miditest}
\begin{test}{Test 1}
...
\begin{Exercise}[label=408]
  ...
  \end{enumerate}
\komentar{Milena: Nije mi jasno cemu odgovaraju ovi test primer, tj sta je program. Da li program testira samo jednu funkciju ili obe? To nekako treba reci.}  
\begin{minitest}
\begin{test}{Test 1}
Ulaz:       10
Izlaz:      3
