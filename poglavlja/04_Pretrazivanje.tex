...
\begin{Exercise}[label=401]
  ...
  \item Linearna pretraga niza\\ Napisati funkciju koja pretražuje niz
    celih brojeva dužine \argf{n}, tražeći u njemu element
    \argf{x}. Pretraga se vrši prostom iteracijom kroz niz. Ako se
  ...
  \item Binarna pretraga niza\\ Napisati funkciju koja traži u
    sortiranom nizu \argf{a[]} duzine \argf{n} broj \argf{x} i vraća
